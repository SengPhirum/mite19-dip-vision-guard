...
class SuicideRiskDetector:
    def __init__(self, fps, hazard_roi_norm=(0.05, 0.6, 0.95, 0.98), dwell_threshold_sec=8.0):
        """
        hazard_roi_norm: (x1,y1,x2,y2) normalized [0,1] coordinates of danger zone
        """
        self.fps = fps
    ...
    def update(self, tracks, frame_shape):
        ...
        for tid, st in tracks.items():
            ...
            if ts["dwell_frames"] >= self.dwell_threshold_frames and ts["entries"] >= 2:
                events.append(tid)
